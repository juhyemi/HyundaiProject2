...
<link rel="stylesheet" type="text/css"
	href="../resources/css/member/join1.css">
<link rel="stylesheet" type="text/css"
	href="../resources/css/member/join2.css">	
</head>
<body>
	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				<div class="join-wrap">
					<form id="joinForm" name="joinForm" action="/member/joinAction" method="post">
								...
								<fieldset>
									...
									<div>
										<div class="form-block">
											<label class="ePlaceholderEach required" title="이름*">
												...
												<input id="name" name="mem_name" placeholder="이름*" maxlength="30" value="" type="text">
												<div class="info-msg displaynone" id="under14Msg">
									...
									<div>
										<div class="form-block email-block flex-column-2">
											...
											<button type="button" id="btn_action_verify_mobile" class="btn btn-md btn-white btn-135">
												인증번호받기
											</button>
										</div>
									</div>
											...
											<div class="birthday">
												<div class="day">
													<label title="생년*" class="ePlaceholderEach">
														...
														<input id="birth_year" name="birth_year" class="inputTypeText" placeholder="생년" maxlength="4"	value="" type="text">
													</label> 
													<label title="월*" class="ePlaceholderEach">
														<p class="form-title">월</p> 
														<input id="birth_month" name="birth_month" class="inputTypeText" placeholder="월" maxlength="2" value="" type="text">
													</label> 
													<label title="일*" class="ePlaceholderEach">
														<p class="form-title">일</p> 
														<input id="birth_day" name="birth_day" class="inputTypeText" placeholder="일" maxlength="2"	value="" type="text">
													</label>
												</div>
							...
							<div class="agree-block">
								<div class="agree-title">
									<div class="text">
										...
										<label for="sAgreeAllChecked" class="all">이용약관 및
											개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</label>
									</div>
								</div>
							</div>
							<div class="agree-block">
							...
							<div id="agree_service_check" class="agree-desc-block active">
								<div class="block">
									<div class="fr-view fr-view-mall-agreement">
										<p>
											제1조(목적)<br>이 약관은(주)마뗑킴 (전자상거래 사업자)이 운영하는 MATINKIM.COM
											사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어
											사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>※「PC통신, 무선
										...
										<p>
											...
											‘회원’이라 함은 “몰”에 (삭제) 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수
											있는 자를 말합니다.<br>④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를
											이용하는 자를 말합니다.
										</p>
										...
										<p>
											...
											승낙이 회원에게 도달한 시점으로 합니다.<br>④ 회원은 회원가입 시 등록한 사항에 변경이 있는
										...
										<p>
											...
											자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는
											경우 “몰”은 회원자격을 상실시킬 수 있습니다.<br>④ “몰”이 회원자격을 상실시키는 경우에는
											회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을
											정하여 소명할 기회를 부여합니다.
										</p>
										...
										<p>
											...
											처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
										</p>
										...
										<p>
											...
											소비자보호에 관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.<br>② 이용자는 재화
											등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br>&nbsp;
										...
										<p>
											...
											최소한의 개인정보를 수집합니다.<br>② “몰”은 회원가입시 구매계약이행에 필요한 정보를 미리
											수집하지 않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에 본인확인이 필요한 경우로서 최소한의
											특정 개인정보를 수집하는 경우에는 그러하지 아니합니다.<br>③ “몰”은 이용자의 개인정보를
											수집•이용하는 때에는 당해 이용자에게 그 목적을 고지하고 동의를 받습니다.<br>④ “몰”은 수집된
											개인정보를 목적외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한 경우 또는 제3자에게 제공하는 경우에는
											이용•제공단계에서 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. 다만, 관련 법령에 달리 정함이 있는
											경우에는 예외로 합니다.<br>⑤ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는
											경우에는 개인정보보호 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적,
											...
											열람 및 오류정정을 요구할 수 있으며 “몰”은 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다.
											이용자가 오류의 정정을 요구한 경우에는 “몰”은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.<br>⑦
											“몰”은 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드,
											은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한
											이용자의 손해에 대하여 모든 책임을 집니다.<br>⑧ “몰” 또는 그로부터 개인정보를 제공받은
											제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.<br>⑨
											“몰”은 개인정보의 수집•이용•제공에 관한 동의란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의
										...
										<p>
											...
											시스템을 갖추어야 합니다.<br>③ “몰”이 상품이나 용역에 대하여 「표시․광고의 공정화에 관한
											법률」 제3조 소정의 부당한 표시․광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.<br>④
										...
										<p>
											...
											또는 변경시 허위 내용의 등록<br>2. 타인의 정보 도용<br>3. “몰”에 게시된 정보의
											변경<br>4. “몰”이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시<br>5.
										...
										<p>
											...
											독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을
											연결“몰”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증 책임을 지지
											않습니다.
										</p>
										...
										<p>
											...
											제기합니다.<br>② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
										</p>
									...
									<div class="text">
										<p>
											<input id="agree_privacy_check0" name="agree_privacy_check[]"
												...
												fw-msg="개인정보 수집 및 이용 방침에 동의하세요" class="ec-base-chk"
