		...
		<div id="contents">
			...
			<div class="join-wrap">
				...
				<form id="joinForm" name="joinForm"
					action="/exec/front/Member/join/" method="post" target="_self"
					...
					<div class="xans-element- xans-member xans-member-join">
							...
							<fieldset>
								<div class="member-id-block">
									...
									<button type="button" class="btn btn-sm btn-dark btn-id-check"
										onclick="checkId('/member/check_id.html')">
										<span>중복확인</span>
									</button>
								</div>
								...
								<div>
									<div class="form-block">
										<label class="ePlaceholderEach required" title="비밀번호*">
											...
											name="passwd" fw-filter="isFill&amp;isMin[4]&amp;isMax[16]"
											fw-label="비밀번호" fw-msg="" autocomplete="off" maxlength="16"
											0="disabled" value="" type="password" placeholder="비밀번호*">
									...
									<div class="form-block">
										<label class="ePlaceholderEach required" title="비밀번호 확인*">
											...
											0="disabled" value="" type="password" placeholder="비밀번호 확인*">
								...
								<div class="displaynone">
									<label class="select required active">
										<p class="form-title active">비밀번호 확인 질문*</p> <select id="hint"
										name="hint" fw-filter="" fw-label="hint" fw-msg="">
								...
								<div class="displaynone">
									<label class="ePlaceholderEach required" title="비밀번호 확인 답변*">
										<p class="form-title">비밀번호 확인 답변*</p> <input id="hint_answer"
										name="hint_answer" fw-filter="" fw-label="비밀번호 확인시 답변"
										fw-msg="" class="inputTypeText" placeholder="비밀번호 확인 답변*"
										value="" type="text">
								...
								<div>
									<div class="form-block">
										<label class="ePlaceholderEach required" title="이름*">
											...
											class="ec-member-name" placeholder="이름*" maxlength="30"
											value="" type="text">
											<div class="info-msg displaynone" id="under14Msg">14세
												미만 사용자는 법정대리인 동의가 필요합니다.</div>
								...
								<div class="displaynone">
									<div class="form-block">
										<label class="ePlaceholderEach" title="이름(영문)*"
											data-required="displaynone">
											<p>이름(영문)*</p>
											<input id="name_en" name="name_en"
											fw-filter="isMax[30]&amp;isAlphaSpace" fw-label="이름(영문)"
											fw-msg="" class="ec-member-name" placeholder="이름(영문)"
								...
								<div class=" ePlaceholderGroup" style="width: 100%;"
									...
									<div class="form-block phone-block flex-column-2">
										...
										<button type="button" id="btn_action_verify_mobile"
											...
											onclick="memberVerifyMobile.joinSendVerificationNumber(); return false;">인증번호
											받기</button>
									</div>

									<p class="displaynone" id="result_send_verify_mobile_fail"></p>
									<ul class="displaynone" id="result_send_verify_mobile_success">
										<li>인증번호가 발송되었습니다.</li>
									...
									<div class="form-block phone-verify-block flex-column-2">
										<div class="phone-verify">
											<input id="verify_sms_number" name="verify_sms_number"
												fw-filter="isMax[15]" fw-label="verify_sms_number" fw-msg=""
												class="inputTypeText" placeholder="" maxlength="15" value=""
												type="text"> <span class="time" id="expiryTime">2:00</span>
										</div>
										<button type="button" class="btn btn-md btn-white btn-135"
											id="btn_verify_mobile_confirm"
											onclick="memberVerifyMobile.joinVerifySmsNumberConfirm(); return false;">확인</button>
									</div>
								</div>
										...
										<div class="birthday">
											...
											<div class="radio-block">
												<span class=""><input id="is_solar_calendar0"
													...
													fw-msg="" value="T" type="radio" checked="checked"
													autocomplete="off"><label for="is_solar_calendar0">양력</label>
								...
								<div class="text">
									<p>
										<span class="ec-base-chk"><input type="checkbox"
											id="sAgreeAllChecked"><em class="checkbox"></em></span>
									</p>
									<label for="sAgreeAllChecked" class="all">이용약관 및 개인정보수집
										및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</label>
								</div>
							</div>
						</div>
						<div class="agree-block">
							<div class="agree-title">
								<div class="text">
									<p>
										<input id="agree_service_check0" name="agree_service_check[]"
								...
								<button type="button"
									onclick="agreeDescToggle('agree_service_check')">
									<i></i>
								</button>
							</div>
						</div>
						<div id="agree_service_check" class="agree-desc-block active">
							<div class="block">
								<div class="fr-view fr-view-mall-agreement">
									<p>
										제1조(목적)<br>이 약관은(주)마뗑킴 (전자상거래 사업자)이 운영하는 MATINKIM.COM 사이버
									...
									<p>
										제2조(정의)<br>① “몰”이란 (주)마뗑킴 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
									...
									<p>
										...
										통지 가능한 주소로 즉시 통지합니다.<br>④ 전항의 경우 “몰”은 이로 인하여 이용자가 입은 손해를
										배상합니다. 다만, “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
									</p>
									...
									<p>
										...
										사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에 정한
										방법으로 이용자에게 통지하고 당초 “몰”에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준
										등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 “몰”에서 통용되는 통화가치에 상응하는 현물
										또는 현금으로 이용자에게 지급합니다.
									</p>
									...
									<p>
										...
										것이 “몰”의 기술상 현저히 지장이 있다고 판단되는 경우<br>③ 회원가입계약의 성립 시기는 “몰”의
										승낙이 회원에게 도달한 시점으로 합니다.<br>④ 회원은 회원가입 시 등록한 사항에 변경이 있는 경우,
									...
									<p>
										...
										경우<br>&nbsp; 2. “몰”을 이용하여 구입한 재화 등의 대금, 기타 “몰”이용에 관련하여
										회원이 부담하는 채무를 기일에 지급하지 않는 경우<br>&nbsp; 3. 다른 사람의 “몰” 이용을
										방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우<br>&nbsp; 4. “몰”을
										이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우<br>③ “몰”이 회원
										자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우
										“몰”은 회원자격을 상실시킬 수 있습니다.<br>④ “몰”이 회원자격을 상실시키는 경우에는 회원등록을
										말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할
										기회를 부여합니다.
									</p>
									...
									<p>
										...
										재화등의 구매신청 및 이에 관한 확인 또는 “몰”의 확인에 대한 동의<br>&nbsp; 6. 결제방법의
										선택<br>② “몰”이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시
										구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는
										개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용 기간 등을 구매자에게 명시하여야
										합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우
										등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
									</p>
									...
									<p>
										...
										조치를 취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는
										일부를 받은 날부터 3영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화 등의 공급 절차 및 진행
										사항을 확인할 수 있도록 적절한 조치를 합니다.<br>② “몰”은 이용자가 구매한 재화에 대해
									...
									<p>
										...
										이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의 소비자보호에 관한
										법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.<br>② 이용자는 재화 등을 배송 받은
										경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br>&nbsp; 1.
										이용자에게 책임 있는 사유로 재화 등이 멸실 또는 훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장
										등을 훼손한 경우에는 청약철회를 할 수 있습니다)<br>&nbsp; 2. 이용자의 사용 또는 일부
									...
									<p>
										...
										지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서 정하는 지연이자율(괄호
										부분 삭제)을 곱하여 산정한 지연이자를 지급합니다.<br>② “몰”은 위 대금을 환급함에 있어서
										이용자가 신용카드 또는 전자화폐 등의 결제수단으로 재화 등의 대금을 지급한 때에는 지체 없이 당해 결제수단을
										제공한 사업자로 하여금 재화 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.<br>③ 청약철회
										등의 경우 공급받은 재화 등의 반환에 필요한 비용은 이용자가 부담합니다. “몰”은 이용자에게 청약철회 등을
										이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 재화 등의 내용이 표시•광고 내용과 다르거나 계약내용과
										다르게 이행되어 청약철회 등을 하는 경우 재화 등의 반환에 필요한 비용은 “몰”이 부담합니다.<br>④
									...
									<p>
										...
										개인정보보호 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에
										대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 「정보통신망 이용촉진 및 정보보호 등에
										관한 법률」 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수
										있습니다.<br>⑥ 이용자는 언제든지 “몰”이 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을
										요구할 수 있으며 “몰”은 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을
										요구한 경우에는 “몰”은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.<br>⑦ “몰”은
										개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을
										포함한 이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한 이용자의 손해에
										대하여 모든 책임을 집니다.<br>⑧ “몰” 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의
										수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.<br>⑨ “몰”은
									...
									<p>
										...
										”몰“에 귀속합니다.<br>② 이용자는 “몰”을 이용함으로써 얻은 정보 중 “몰”에게 지적재산권이
										귀속된 정보를 “몰”의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로
										이용하거나 제3자에게 이용하게 하여서는 안됩니다.<br>③ “몰”은 약정에 따라 이용자에게 귀속된
						...
						<div class="agree-block">
							<div class="agree-title">
								<div class="text">
									<p>
										<input id="agree_privacy_check0" name="agree_privacy_check[]"
								...
								<button type="button"
									onclick="agreeDescToggle('agree_privacy_check')">
									<i></i>
								</button>
							</div>
						</div>
							...
							<div class="block">
								<div class="fr-view fr-view-privacy-required">
									...
									<p>회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지
										, 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리
										등 민원처리 , 고지사항 전달</p>
						...
						<div class="displaynone">
							<div class="agree-block">
								<div class="agree-title">
									<div class="text">
										<p>
											<input id="agree_privacy_optional_check0"
												name="agree_privacy_optional_check[]" fw-filter=""
												fw-label="개인정보 수집 및 이용 동의 (선택)" fw-msg=""
												class="ec-base-chk" value="T" type="checkbox"><label
												for="agree_privacy_optional_check0">동의함</label>
										</p>
										<label for="agree_privacy_optional_check0">[선택] 개인정보
											수집 및 이용 동의</label>
									</div>
									<button type="button"
										onclick="agreeDescToggle('agree_privacy_optional_check')">
										<i></i>
									</button>
								</div>
							</div>
							<div id="agree_privacy_optional_check" class="agree-desc-block">
								<div class="block">
									<div class="fr-view fr-view-privacy-optional">
										1. 개인정보 수집목적 및 이용목적<br>회원가입 시 입력받는 선택 항목의 이용 목적 기재 (예시 :
										맞춤형 콘텐츠 추천 및 마케팅 활용)<br>
										<br>2. 수집하는 개인정보 항목<br>회원가입 시 입력받는 선택 항목 기재 (예시:
										생년월일, 성별)<br>
										<br>3. 개인정보의 보유기간 및 이용기간<br>회원탈퇴 또는 회원정보 수정을 통해 해당
										항목 삭제 시 지체없이 파기합니다.<br>
										<br>※ 동의를 거부하시는 경우에도 서비스는 이용이 가능합니다.
									</div>
								</div>
							</div>
						</div>
						<div class="displaynone">
							<div class="agree-block">
								<div class="agree-title">
									<div class="text">
										<p>
											<input id="agree_information_check0"
										...
										<label for="agree_information_check0">[선택] 개인정보 제3자 제공
											동의</label>
									</div>
									<button type="button"
										onclick="agreeDescToggle('agree_information_check')">
										<i></i>
									</button>
								</div>
							</div>
							<div id="agree_information_check" class="agree-desc-block">
								<div class="block">
									아래 내용의 동의 여부는 회원가입에 영향을 미치지 않습니다. 단, 동의 거부시 서비스 이용에 제한이 있을 수
									있습니다.<br> <br> - 제공 받는 자 :<br> <br> - 제공 항목
									:<br> <br> - 제공 목적 :<br> <br> - 보유 및 이용기간 :<br>
								</div>
							</div>
						</div>
						<div class="displaynone">
							<div class="agree-block">
								<div class="agree-title">
									<div class="text">
										<p>
											<input id="agree_consignment_check0"
												name="agree_consignment_check[]" fw-filter=""
												fw-label="개인정보 처리 위탁 동의" fw-msg="" class="ec-base-chk"
												value="1" type="checkbox"><label
												for="agree_consignment_check0">동의함</label>
										</p>
										<label for="agree_consignment_check0">[선택] 개인정보 처리 위탁
											동의</label>
									</div>
									<button type="button"
										onclick="agreeDescToggle('agree_consignment_check')">
										<i></i>
									</button>
								</div>
							</div>
							<div id="agree_consignment_check" class="agree-desc-block">
								<div class="block">
									아래 내용의 동의 여부는 회원가입에 영향을 미치지 않습니다. 단, 동의 거부시 서비스 이용에 제한이 있을 수
									있습니다.<br> <br> - 위탁받는 자(수탁업체) :<br> <br> -
									위탁업무의 내용:<br>
								</div>
							</div>
						</div>
							...
							<div class="">
								<div class="agree-block">
									<div class="agree-title">
										<div class="text">
											<p>
												<input id="is_sms0" name="is_sms" fw-label="is_sms"
													fw-msg="" class="ec-base-chk" value="T" type="checkbox"><label
													for="is_sms0">동의함</label>
											</p>
											<label for="is_sms0">[선택] SMS 수신을 동의하십니까?</label>
										</div>
									</div>
								</div>
							</div>
							<div class="displaynone">
								<div class="agree-block">
									<div class="agree-title">
										<div class="text">
											<p>
												<input id="is_news_mail0" name="is_news_mail" fw-filter=""
													fw-label="is_news_mail" fw-msg="" class="ec-base-chk"
													value="T" type="checkbox"><label
													for="is_news_mail0">동의함</label>
											</p>
											<label for="is_news_mail0">[선택] 이메일 수신을 동의하십니까?</label>
										</div>
									</div>
								</div>
							</div>
