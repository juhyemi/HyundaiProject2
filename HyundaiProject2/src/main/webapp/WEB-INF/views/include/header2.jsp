<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <div class="basket-block">
      <div class="basket-wrap-iframe">
         <iframe class="basket-iframe" id="basketIframe" name="basketIframe"></iframe>
      </div>
   </div>
   ...
   <div id="gnb">
      ...
      <div class="menu-block depth1">
         <ul>
            <li><a href="/product/list.html?cate_no=45"><span>New
                     In</span></a></li>
            <li class="is-sub"><a href="javascript:void(0);"><span>Shop</span><i></i></a></li>
      ...
      <div class="menu-block depth2 search" >
         <div class="sub">
            <div class="block">
