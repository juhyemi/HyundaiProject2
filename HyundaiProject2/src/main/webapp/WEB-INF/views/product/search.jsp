    ...
    <ul class="js-prdList prdList grid4">
		<c:forEach var="searchResult" items = "${list}">
 			   <li id="anchorBoxId_3493" class="xans-record-">
                        <div class="thumbnail">
                            <div class="prdImg">
                                <a href="/product/option/${searchResult.pro_id }">
                                    <img class="thumb1" src="${searchResult.loc1}" id="eListPrdImage3493_1" ><br>
                                    <img class="thumb2" src="${searchResult.loc2}"  ><br></a>
                            </div>
                        </div>
                        <div class="description">
                            <p class="name"><a href="/product/option/${searchResult.pro_id}" class=""><span style="font-size:12px;color:#555555;"><c:out value="${searchResult.pro_name }" /></span></a></p>
                            <p class="price">
                                <span class="dc-price displaynone"></span>
                                <span class="product-price"><fmt:formatNumber type="number" maxFractionDigits="3" value="${searchResult.pro_price}" /></span>
