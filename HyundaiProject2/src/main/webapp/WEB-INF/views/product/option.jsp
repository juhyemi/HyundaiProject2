					...
					<div class="xans-element- xans-product xans-product-detail detail-block">
						...
						<div class="product-form sticky" style="top: -380px;">
							<div class="header">
								...
								<div class="xans-element- xans-product xans-product-detaildesign product-detail-block">
									...
									<p class="summary_desc_css xans-record-">
										<span class="title"><span style="font-size: 12px; color: #555555;">상품요약정보</span></span> <span class="value"><span style="font-size: 12px; color: #555555;">포근하고 부드러운 촉감의 입체감이 있는 텍스처, 후드와 배색이 포인트인 투웨이 후드 가디건</span></span>
									</p>
									<p class="prd_price_sale_css xans-record-">
										<span class="title"><span style="font-size: 14px; color: #000000; font-weight: bold;">할인판매가</span></span> <span class="value"><span><span style="font-size: 14px; color: #000000; font-weight: bold;"><span id="span_product_price_sale">169,200 </span></span></span></span>
									</p>
									<ul class="discountMember">
										<li><a href="#">
												<img class="ec-front-product-show-benefit-icon" product-no="3492" benefit="DP" src="//img.echosting.cafe24.com/skin/admin_ko_KR/product/btn_disc_period.gif" alt="기간할인">
											</a></li>
									</ul>
									<p></p>
									...
									<p class="simple_desc_css xans-record-">
										<span class="title"><span style="font-size: 12px; color: #555555;">상품간략설명</span></span> <span class="value"><span style="font-size: 12px; color: #555555;"><strong>12/28, PM12:00 OPEN - 1/25 순차 출고</strong><br>무통장 입금 결제 건의 경우, 추가 오픈 시간 이전까지 입금 완료되지 않을 경우 자동으로 다음 차수의 주문 건과 함께 배송됩니다.<br>*추가 오픈될 경우에 해당, 모든 재 오픈 차수 동일</span></span>
									</p>
									<p class="made_in_css xans-record-">
										<span class="title"><span style="font-size: 12px; color: #555555;">원산지</span></span> <span class="value"><span style="font-size: 12px; color: #555555;">국내 </span></span>
									</p>
									<p class="print_date_css xans-record-">
										<span class="title"><span style="font-size: 12px; color: 555555;">제조일자</span></span> <span class="value"><span style="font-size: 12px; color: 555555;">2022-11</span></span>
									</p>
									<p class="quantity_css xans-record-">
										<span class="title"><span style="font-size: 12px; color: #555555;">수량</span></span> <span class="value"><span style="font-size: 12px; color: #555555;"><span id="NewProductQuantityDummy"><span class="quantity"><input id="quantity" name="quantity_name" style="width: 30px; height: 18px; border: 1px solid #BCBCBC;" value="" type="text"><img src="//img.echosting.cafe24.com/design/skin/mono/product/btn_basketUp.gif" class="QuantityUp" alt="수량증가"><img src="//img.echosting.cafe24.com/design/skin/mono/product/btn_basketDown.gif" class="QuantityDown" alt="수량감소"></span></span></span></span>
									</p>
								</div>
								...
								<div class="displaynone">
									...
									<div class="xans-element- xans-product xans-product-additional simple-desc-block ">포근하고 부드러운 촉감의 입체감이 있는 텍스처, 후드와 배색이 포인트인 투웨이 후드 가디건</div>
									<div class="price-block">
										<span id="span_product_price_text" style="text-decoration: line-through;">188,000</span> <s class="price188,000">188,000</s> <span class="dc-price">169,200</span>
									</div>
								</div>
							</div>
							...
							<div class="xans-element- xans-product xans-product-option xans-record-">
								<div class="xans-element- xans-product xans-product-option xans-record-">
									...
									<div class="option-block">
										...
										<select required="true" product_option_area_select="product_option_3492_0" id="product_option_id1" name="option1" option_title="SIZE" option_type="T" item_listing_type="C" class="ProductOption0 displaynone"><option value="*">empty</option>
							...
							<div class="xans-element- xans-product xans-product-action product-action-block">
								...
								<button type="button" class="btn btn-order btn-dark-disabled btn-full btn-soldout displaynone">
									<span>SOLD OUT</span>
								</button>
								<div class="option-soldout-restock-block displaynone ">
									<button type="button" class="btn btn-order btn-dark btn-full btn-loading btn-resotck displaynone" sms_restock_login_display="" onclick="smsRestockAct()">
										<span>재입고 알림</span>
									</button>
								</div>
							...
							<div class="xans-element- xans-product xans-product-additional info-block">
								<ul class="info-tab">
									<li class="js-delivery active"><a href="javascript:infoAct('delivery');">
											<span>DELIVERY</span>
										</a></li>
									<li class="js-details"><a href="javascript:infoAct('details');">
											<span>DETAILS</span>
										</a></li>
								...
								<div id="delivery" class="info-desc active" style="height: 522.333px;">
									<strong>12/28, PM12:00 OPEN - 1/25 순차 출고</strong><br>무통장 입금 결제 건의 경우, 추가 오픈 시간 이전까지 입금 완료되지 않을 경우 자동으로 다음 차수의 주문 건과 함께 배송됩니다.<br>*추가 오픈될 경우에 해당, 모든 재 오픈 차수 동일
								</div>
								<div id="details" class="info-desc" style="height: 522.333px;">
									겉감 - 폴리에스터 56%, 아크릴 28%, 램스울 12%, 폴리우레탄 4% <br> 배색 - 램스울 50%, 캐시나일론 50% <br> 니트 드라이클리닝 권장 <br> <br> -비침 없음 <br> -신축성 좋음 <br> -안감 없음 <br> -두께감 보통 <br> <br> *단독 드라이클리닝을 권장합니다. <br> *열과 수축에 주의하여 주십시오. <br> *이염에 주의하여 주십시오. <br> *소재 특성상 필링(보풀)이 생길 수 있습니다. <br> *올풀림에 주의하여 주십시오. <br> *모니터에 따라 컬러의 오차가 있을 수 있습니다. <br> <br> *모든 예약 배송 상품은 상품의 재고가 있을 경우 안내된 기간보다 빠르게 배송될 수 있습니다.
